    ...
    <div className="w-full p-12 md:p-20">
      ...
      <div className="py-10 w-full sm:w-[85%]" data-aos="fade-up">
        <p className=" sm:ml-16 text-sm sm:text-xl">
          ...
          be a part of an exciting journey where your skills, passion, and
          creativity can thrive. Together, let's shape the future of technology!
        </p>
      </div>
    </div>
  );
