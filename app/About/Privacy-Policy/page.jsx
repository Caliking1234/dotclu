  ...
  return (
    ...
    <div className=" w-full md:w-[90%] px-5 lg:px-[200px] py-10 md:p-10">
      ...
      <p className=" text-sm md:text-lg text-gray-500 py-10 " data-aos="fade-up">
        Ideaved and its affiliates are committed to protecting your privacy.
        This Privacy Policy applies to our website (www.ideaved.com) and governs
        ...
        you provide us, please write to us at info.ideaved@gmail.com or ideaved,
        Ghaziabad, Uttar Pradesh, India
      </p>
      <h1 className="text-2xl py-10 font-medium" data-aos="fade-up">Use of the Subscription Service</h1>
      <p className=" text-sm md:text-lg text-gray-500 py-10" data-aos="fade-up">
        Our online Subscription Service allows us to create and share marketing mailers and collaterals. The information added to the Subscription Service by users while subscribing to the website is stored and managed by our servers. This information is then used to contact visitors about their interest in the company's services. Ideaved provides the Subscription Service to our clients for their own marketing, lead generation, and customer service needs, and we use the same for our business requirements. We use our own Subscription Service to build web pages that people can visit to learn more about Ideaved. Information that we collect and manage using the Subscription Service belongs to us and is used, disclosed, and protected according to this Privacy Policy.
      </p>
