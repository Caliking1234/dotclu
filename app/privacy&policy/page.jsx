      ...
      <div className="w-full p-8 sm:p-12 md:p-20">
        <div data-aos="fade-up">
          ...
          <p className=" sm:text-lg pl-8 py-3">
            ...
            contact us at <span className=" text-blue-500 border-b-[1px] border-transparent hover:border-blue-500 transition-all duration-100 ease-in cursor-pointer">info.ideaved@gmail.com</span>
          </p>
        </div>
      </div>
      <div className="w-full p-8 sm:p-12 md:p-20">
